...
import it.syscake.notificationlistenerlibrary.listener.NotificationListener2;
...
public class MainActivity extends AppCompatActivity implements ServiceConnection, Callback {
    ...
    private NotificationListener2 service;
    ...
    private void startService() {
        if(service == null) {
            Intent serviceIntent = new Intent(this, NotificationListener2.class);
//            startService(serviceIntent);
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        this.service = ((NotificationListener2.LocalBinder) iBinder).getService();
        if(service != null) {
